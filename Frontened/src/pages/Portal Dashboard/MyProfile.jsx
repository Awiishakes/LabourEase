...
const MyProfile = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios.put(`https://labourease-production.up.railway.app/api/user/updateProfile/${user._id}`, formData, { withCredentials: true, headers: {Authorization: `Bearer ${localStorage.getItem('token')}`} })
    .then((res)=>{
