...
const ServiceDetials = () => {
  ...
  const getMyService = useCallback(async () =>{
    try {
      const { data } = await axios.get(`https://ingenious-perfection-production.up.railway.app/api/work/getMyService/${id}`, { withCredentials: true })
  ...
  const onSubmit = async (data) => {
    ...
    await axios.put(`https://ingenious-perfection-production.up.railway.app/api/work/update/${id}`, formData, { withCredentials: true })
    .then((res)=>{
  ...
  const handleToggle = async (active) => {
    await axios.patch(`https://ingenious-perfection-production.up.railway.app/api/work/updateStatus/${id}`, { active }, { withCredentials:true })
  ...
  const onRequestSubmit = async (formData) =>{
      try {
          const {data} = await axios.post('https://ingenious-perfection-production.up.railway.app/api/request/postRequest', formData,
              {
