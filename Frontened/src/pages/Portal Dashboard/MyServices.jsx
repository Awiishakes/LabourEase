...
function MyServices() {
  ...
  useEffect(() => {
    const getAllMyPosts = async () =>{
      setLoading(true)
      await axios.get('https://ingenious-perfection-production.up.railway.app/api/work/getMyServices', { withCredentials: true })
      .then((res)=>{
  ...
  const handleDelete = async () =>{
    await axios.delete(`https://ingenious-perfection-production.up.railway.app/api/work/delete/${state.id}`,{ withCredentials: true })
    .then((res)=>{
