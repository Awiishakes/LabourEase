...
const ImageSocket = ({image, index, onUpload, onDelete, editMode}) => {
    ...
    const handleImageUpload = async (file) => {
        ...
        await axios.post('https://ingenious-perfection-production.up.railway.app/api/request/uploadImage', imageData, {withCredentials:true,
    ...
    const handleImageDelete = async () => {
        await axios.delete(`https://ingenious-perfection-production.up.railway.app/api/request/deleteImage/${image.public_id}`, {withCredentials:true} )
        .then((res)=>{
            onDelete(index)
            toast.success(res.data.message)
        })
