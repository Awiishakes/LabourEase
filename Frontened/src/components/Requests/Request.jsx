...
const Request = ({ workerAvailability, onClose, onSubmit, workId }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1001] bg-gray-800 bg-opacity-50 flex justify-center items-center overflow-auto">
      <div className="bg-[#101820] relative rounded-lg shadow-lg px-6 py-5 w-full max-w-lg text-white">
        ...
        <h2 className="text-xl font-semibold mb-4 text-yellow-400">{t('newRequest.title')}</h2>
        ...
        <form onSubmit={handleSubmit(onFormSubmit)}>
            <div className={`${currentStep === 2 && 'absolute invisible'}`}>
              ...
              <div className="w-full flex gap-x-2">
                <div className="mb-4 flex-1">
                  <label className="block text-sm font-medium mb-1 text-yellow-500">{t('city')}</label>
                  <select
                    {...register("city")}
              ...
              <div className="mb-4 h-32 overflow-y-auto" style={{scrollbarWidth: 'thin', scrollbarColor:'#facc15 transparent'}}>
                <label className="block text-sm font-medium mb-1 text-yellow-500">{t('fields.selectTime')}</label>
          ...
          {currentStep === 2 && (
            <>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1 text-yellow-500">{t('fields.description')}</label>
                <textarea
                  rows={5}
              ...
              <div className="form-group mb-4">
                <label className="block font-medium mb-2 text-yellow-500">{t('fields.images')}</label>
...
const Input = ({type, name, register, errors}) =>{
  ...
  return(
    <div className="mb-4">
      <label className="block text-sm font-medium mb-1 text-yellow-500 capitalize">{t('fields.'+name)}</label>
      <input
        type={type}
        {...register(name)}
