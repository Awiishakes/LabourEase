...
const MyRequests = () => {
  ...
  const fetchRequests = useCallback(async () => {
    try {
      setLoading(true);
      const response = await axios.get("https://ingenious-perfection-production.up.railway.app/api/request/getAll", { withCredentials: true })
  ...
  const handleDelete = useCallback(async () => {
    try {
      setDeleting(true)
      const res = await axios.delete(`https://ingenious-perfection-production.up.railway.app/api/request/delete/${statusData.id}`,{ withCredentials: true })
  ...
  const handleRequestStatus = useCallback(async () => {
    try {
      const res = await axios.patch(`https://ingenious-perfection-production.up.railway.app/api/request/updateStatus/${statusData.id}`, { status: statusData.status }, { withCredentials: true })
  ...
  const handleRatings = useCallback(async (ratings) => {
    try {
      await axios.patch(`https://ingenious-perfection-production.up.railway.app/api/work/updateRatings/${statusData.id}`, { ratings }, { withCredentials: true })
      handleRequestStatus()
