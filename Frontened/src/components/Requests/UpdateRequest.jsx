...
const UpdateRequest = () => {
  ...
  useEffect(() => {
    const getMyRequest = async () => {
      try {
        const res = await axios.get(`https://ingenious-perfection-production.up.railway.app/api/request/getMyRequest/${id}`, { withCredentials: true });
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const res = await axios.put(`https://ingenious-perfection-production.up.railway.app/api/request/update/${id}`, formData, { withCredentials: true });
  ...
  const handleRequestStatus = useCallback(async () => {
    try {
      const res = await axios.patch(`https://ingenious-perfection-production.up.railway.app/api/request/updateStatus/${id}`, { status: state.status }, { withCredentials: true });
      toast.success(res.data.message);
